...
namespace ArbolBianario
{
    class CNodo
    {
        ...
        private CNodo rightNode;
        public CNodo RightNode
        {
            get { return rightNode; }
            set { rightNode = value; }
        }//Right Child

        private CNodo leftNode;
        public CNodo LeftNode
        {
            get { return leftNode; }
            set { leftNode = value; }
        }//left Child
        ...
        public CNodo Find(int value)
        {
            //this node is the starting current node
            CNodo currentNode = this;
        ...
        public CNodo FindRecursive(int value)
        {
