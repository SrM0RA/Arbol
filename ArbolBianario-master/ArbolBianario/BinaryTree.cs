...
namespace ArbolBianario
{
    class BinaryTree
    {
        ...
        //O(Log n)
        public CNodo FindRecursive(int data)
        {
        ...
        public void Remove(int data)
        {
            ...
            else//Current Node has both a left and a right child
            {
                ...
                CNodo successor = GetSuccessor(current);
        ...
        private CNodo GetSuccessor(CNodo node)
        {
            CNodo parentOfSuccessor = node;
            CNodo successor = node;
            CNodo current = node.RightNode;
